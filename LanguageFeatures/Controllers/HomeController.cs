...
namespace LanguageFeatures.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ViewResult UseFilterExtensionMethod()
        {
            ...
            /* Replaced by code in for each loop below
            Func<Product, bool> categoryFilter = prod => prod.Category == "Soccer";
            */
                           
            /* Replaced by lambda expression above
            ...
            */
            decimal total = 0;
            foreach (Product prod in products.Filter/*ByCategory("Soccer")*/(prod => prod.Category =="Soccer" || prod.Price > 20))
            {
                total += prod.Price;
            }
        ...
        public ViewResult FindProducts()
        {
            ...
            /* replaced following LINQ query syntax with dot-notation syntax above
            ...
            */
            ...
            foreach (var p in foundProducts)
            {
                ...
                /* removed when dot-notation syntax was used, because if was used with the LINQ query syntax
                if (++count == 3)
                {
                    break;
                }
